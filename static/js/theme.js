...
$(function () {
  ...
  const bookingDetailSlider = new Swiper('.booking-detail-slider', {
    slidesPerView: 2,
    spaceBetween: 0,
    centeredSlides: true,
    loop: true,
  ...
  const itemsSliderFull = new Swiper('.items-slider-full', {
    slidesPerView: 6,
    spaceBetween: 20,
    loop: true,
    roundLengths: true,
  ...
  $('.btn-items-decrease').on('click', function () {
    const input = $(this).siblings('.input-items')
  ...
  $('.btn-collapse').each(function () {
    const button = $(this)
    const collapseId = button.attr('data-bs-target')
